/**
 * Skill manifest — defines which skills Orbiter auto-installs into ~/.claude/skills/.
 *
 * Two source types:
 *   - github: downloaded from a pinned commit SHA (deterministic, not branch tip)
 *   - bundled: copied from Orbiter's own resources (for skills we author ourselves)
 *
